...
{
    /// <inheritdoc />
<<<<<<<< HEAD:Benaa.Infrastructure/Migrations/20240519171107_addDb.cs
    public partial class addDb : Migration
========
    public partial class ADD : Migration
>>>>>>>> OwnerDashBaord:Benaa.Infrastructure/Migrations/20240517212140_ADD.cs
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_BankInformations_BankInformationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageUrl = table.Column<string>(type: "text", nullable: true),
                    TargtedPeople = table.Column<string>(type: "text", nullable: true),
                    GoalsDescription = table.Column<string>(type: "text", nullable: true),
                    IsFiles = table.Column<bool>(type: "boolean", nullable: true),
                    IsRecorded = table.Column<bool>(type: "boolean", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Notifactions_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sceduales_AspNetUsers_StudentId",
                        column: x => x.StudentId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Sceduales_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScedualeId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseChapterId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                {
<<<<<<<< HEAD:Benaa.Infrastructure/Migrations/20240519171107_addDb.cs
                    { "2381c993-8971-40d7-8ca2-a163b35b46f1", null, "TEACHER", "TEACHER" },
                    { "2c272f1f-9506-491c-ace6-a477c096a8df", null, "STUDENT", "STUDENT" },
                    { "370daf7a-387e-410b-b0aa-b8105a01acfc", null, "ADMIN", "ADMIN" },
                    { "e1aad4b4-2d90-419e-be54-aa55fc51aa9f", null, "OWNER", "OWNER" }
========
...
>>>>>>>> OwnerDashBaord:Benaa.Infrastructure/Migrations/20240517212140_ADD.cs
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_BankInformationId",
                table: "AspNetUsers",
